...
if(empty($_SESSION["user_id"]) || empty($_SESSION["role"]) || $_SESSION["role"] !== 'admin') {
    ...
    // Redirect to main login with error message
...
// Log out if session is too old (2 hours)
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle"> 
                                    <span class="f-s-40" style="font-weight: bold;">रु</span>
                                </div>
                                <div class="media-body media-text-right">
                                    <h2><?php 
                                        ...
                                        echo 'रु ' . number_format((float)$sum, 2);
                                        ?></h2>
