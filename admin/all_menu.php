...
<body class="fix-header fix-sidebar">
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																				...
																				$fetch=mysqli_fetch_array($newquery);
																					...
																					echo '<tr id="menu-row-'.$rows['d_id'].'"><td>'.$fetch['title'].'</td>
																								...
																								<center><img src="Res_img/dishes/'.$rows['img'].'" class="img-responsive  radius" style="max-height:100px;max-width:150px;" /></center>
																									 ...
																									 <td><a href="javascript:void(0);" onclick="deleteMenu('.$rows['d_id'].')" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
    ...
    function deleteMenu(menuId) {
        if(confirm('Are you sure you want to delete this menu item?')) {
            $.ajax({
                url: 'delete_menu.php?menu_del=' + menuId,
                type: 'GET',
                dataType: 'json',
                success: function(response) {
                    if(response.success) {
                        $('#menu-row-' + menuId).fadeOut(300, function() {
                            $(this).remove();
                        });
                ...
                error: function(xhr, status, error) {
                    alert('Error deleting menu item. Please try again. Status: ' + status);
                }
            });
        }
    }
