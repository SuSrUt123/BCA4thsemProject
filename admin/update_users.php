...
if(isset($_POST['submit'] ))
{
	...
	if(!empty($_POST['password'])) {
		...
		$stmt->bind_param('ssssssi', $_POST['uname'], $_POST['fname'], $_POST['lname'], $_POST['email'], $_POST['phone'], $hashed_password, $user_id);
	} else {
		// Update without changing password
		$stmt = $db->prepare("UPDATE users SET username=?, f_name=?, l_name=?, email=?, phone=? WHERE u_id=?");
		$stmt->bind_param('sssssi', $_POST['uname'], $_POST['fname'], $_POST['lname'], $_POST['email'], $_POST['phone'], $user_id);
	}
										 ...
										 <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" name="password" class="form-control form-control-danger" placeholder="Enter new password or leave blank">
