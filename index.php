...
<head>
    ...
    <link rel="icon" href="#">
    <title>Quick Bites - Your Favorite Food Delivered</title>
...
<body class="home">
    ...
    <header id="header" class="header-scroll top-header headrom">
        ...
        <section class="hero bg-image" data-image-src=images/img/table.jpg style="height: 500px; width: 100%; display: flex; align-items: center; justify-content: center; padding-top: 8%; padding-bottom: 5%;">
            <div class="hero-inner" style="width: 100%;">
                <div class="container text-center hero-text font-white" style="padding: 10px 0;">
                    <h1 style="font-size: 2.5em; margin-bottom: 30px; text-align: center;">"Food you love, delivered with ease" </h1>
                    ...
                    <div class="steps" style="display: flex; justify-content: center; align-items: center; flex-wrap: wrap; gap: 20px;">
                        <div class="step-item step1" style="margin: 0 20px; text-align: center;">
                            <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 483 483" width="512" height="512" style="width: 28px; height: 28px; display: block; margin: 0 auto 10px;">
                                <g fill="#FFF">
                            ...
                            <h4 style="font-size: 16px; margin: 0; text-align: center;"><span style="color:white;">1. </span>Choose Restaurant</h4> </div>
                
                        <div class="step-item step2" style="margin: 0 20px; text-align: center;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewbox="0 0 380.721 380.721" style="width: 28px; height: 28px; display: block; margin: 0 auto 10px;">
                                <g fill="#FFF">
                            ...
                            <h4 style="font-size: 16px; margin: 0; text-align: center;"><span style="color:white;">2. </span>Order Food</h4> </div>
              
                        <div class="step-item step3" style="margin: 0 20px; text-align: center;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewbox="0 0 612.001 612" style="width: 28px; height: 28px; display: block; margin: 0 auto 10px;">
                            ...
                            <h4 style="font-size: 16px; margin: 0; text-align: center;"><span style="color:white;">3. </span>Delivery or check out</h4> </div>
