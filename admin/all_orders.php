																		   ...
																		   <?php 
																			...
																			?>
																						<?php																									
																							...
																							?>
																									 <td>
																									 <a href="order_billing.php?order_id=<?php echo $rows['o_id'];?>" class="btn btn-primary btn-flat btn-addon btn-xs m-b-10" title="View Billing Invoice"><i class="fa fa-file-text-o" style="font-size:16px"></i></a>
																									 <a href="delete_orders.php?order_del=<?php echo $rows['o_id'];?>" onclick="return confirm('Are you sure?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10 m-l-5"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																								<?php
